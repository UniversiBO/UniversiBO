...
{foreach name=listacategorie from=$showFileStudentiTitoli_fileList item=temp_categoria}
	   <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="">
			...
			{foreach name=listafile from=$temp_categoria.file item=temp_file}
				<tr>
				<td><img src="tpl/unibo/pallino1.gif" width="11" height="10" alt="" />&nbsp;<a href="{$temp_file.show_info_uri|escape:"htmlall"}">{$temp_file.titolo|escape:"htmlall"|nl2br|truncate}</a>&nbsp;{if $temp_file.nuova=="true"}&nbsp;&nbsp;<img src="tpl/unibo/icona_new.gif" width="21" height="9" alt="!NEW!" />{/if}</td>
			{/foreach}
		</table>
{/foreach}
