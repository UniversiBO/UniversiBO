...
<p>&nbsp;Formato file:<img src="{$showFileInfo_icona|escape:"htmlall"}" width="32" height="32" alt="{$showFileInfo_tipo|escape:"htmlall"}" border="0" />&nbsp;{$showFileInfo_info|escape:"htmlall"|nl2br|bbcode2html}</p>
...
<p>&nbsp;{$showFileInfo_langDownload|escape:"htmlall"}:&nbsp;<a href="{$showFileInfo_downloadUri|escape:"htmlall"}"><img src="tpl/unibo/file_download_32.gif" width="32" height="32" alt="{$showFileInfo_langDownload|escape:"htmlall"}" border="0" align="top" /></a></p>
 {if $showFileInfo_editFlag == 'true'}
 <p>&nbsp;{$showFileInfo_langEdit|escape:"htmlall"}:&nbsp;<a href="{$showFileInfo_editUri|escape:"htmlall"}"><img src="tpl/unibo/file_edit_32.gif" width="32" height="32" alt="{$showFileInfo_langEdit|escape:"htmlall"}" border="0" align="top" /></a></p>
 {/if}
...
<h4><a href="{$common_canaleURI|escape:"htmlall"}">Torna&nbsp;{$common_langCanaleNome|escape:"htmlall"}</h4>
