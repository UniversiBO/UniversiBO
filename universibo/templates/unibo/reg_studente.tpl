...
<form action="index.php?do=RegStudente&amp;{$common_pageTypeExt|escape:"htmlall"}" id="f4" method="post">
	...
	<p>&nbsp;<label class="label" for="f4_ad_user">{$regStudente_langMail|escape:"htmlall"}</label>&nbsp;
	...
	<p><label class="label" for="f4_password">{$regStudente_langPassword|escape:"htmlall"}</label>&nbsp;
	...
	<p>&nbsp;<label class="label" for="f4_username">{$regStudente_langUsername|escape:"htmlall"}</label>&nbsp;
