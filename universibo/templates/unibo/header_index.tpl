...
<tr><td colspan="3"> {* barra in alto, gif di sinistra LOGO a sfondo BIANCO di dimensioni 150x92,gif per il TITOLO a sfondo del colore della tabella con data e menu di navigazione di dimensioni 600x100 *}
		<div id="header"><ul class="hide"><li><a href="#content" accesskey="3">Vai&nbsp;al&nbsp;contenuto</a></li><li><a href="#navigazione" accesskey="5">Vai&nbsp;alla&nbsp;navigazione</a></li><li><a href="#MyUniversiBO" accesskey="4">Vai&nbsp;al&nbsp;MyUniversiBO</a></li></ul>
			<a href="https://www.universibo.unibo.it/" accesskey="1"><img alt="www.universibo.unibo.it" src="tpl/unibo/logo.gif" width="200" height="92" /></a>
			<img id="logo" src="tpl/unibo/logo_{$common_logoType}.gif" alt="Logo UniversiBO" height="92" width="600" /><p class="TimeInfo">{$common_longDate|escape:"htmlall"} &nbsp;-&nbsp;{$common_time|escape:"htmlall"}</p><a href="#content" class="hide">Salta la navigazione</a>
		</div> {* /header *}
		<div id="menubar">
			<p id="Menu">{if $common_userLoggedIn == 'true'}&nbsp;<a href="{$common_settingsUri|escape:"htmlall"}">{$common_settings|lower|capitalize|escape:"htmlall"}</a>&nbsp;|{/if}&nbsp;<a href="{$common_helpByTopicUri|escape:"htmlall"}">{$common_help|lower|capitalize|escape:"htmlall"}</a>&nbsp;|&nbsp;<a href="{$common_forumUri|escape:"htmlall"}" accesskey="2">{$common_forum|lower|capitalize|escape:"htmlall"}</a>|&nbsp;<a href="{$common_contactsUri|escape:"htmlall"}">{$common_contacts|lower|capitalize|escape:"htmlall"|ereg_replace:" ":"&nbsp;"}</a>&nbsp;|&nbsp;<a href="{$common_contributeUri|escape:"htmlall"}">{$common_contribute|lower|capitalize|escape:"htmlall"}</a>&nbsp;|&nbsp;<a href="{$common_accessibilityUri|escape:"htmlall"}">{$common_accessibility|lower|capitalize|escape:"htmlall"}</a></p>
		</div> {* /menubar *}
</td></tr>
