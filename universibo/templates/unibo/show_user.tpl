...
<p><span>Email: <a href="mailto:mailto:{$showEmailFirstPart}(at){$showEmailSecondPart}">{$showEmailFirstPart}<img src="tpl/unibo/chiocciola.gif" width="9" height="9" alt="(at)" />{$showEmailSecondPart}</a>
{if $showDiritti == 'true'}
