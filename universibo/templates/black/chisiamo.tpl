...
{foreach from=$contacts_personal item=curr_people}
	<!--{$curr_people.nick|escape}-->
		<table summary="{$curr_people.nick|escape}" width="100%" border="0" cellspacing="0" cellpadding="0" alt="tabella con le informazioni su {$curr_people.nick|escape}">
			<tr bgcolor="#000099"> 
				<td colspan="2">
					<table summary="{$curr_people.nick|escape} 2" width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
			...
			<tr bgcolor="#000050"> 
				<td colspan="2" align="center" class="Titolo">{$curr_people.nick|escape}</td>
			</tr>
			<tr bgcolor="#000099" align="center"> 
				<td colspan="2"><img src="tpl/black/invisible.gif" width="1" height="2" alt="" /></td>
			</tr>
			<tr bgcolor="#000032">
          		<td colspan="2" class="Normal">&nbsp;<br />{$curr_people.intro|escape}<br />&nbsp;</td>
			</tr>
			<tr bgcolor="#000099" align="center"> 
				<td colspan="2"><img src="tpl/black/invisible.gif" width="1" height="2" alt="" /></td>
			</tr>
			...
			<tr bgcolor="#000032">
				...
				<td class="Normal">&nbsp;<br />{$curr_people.ruolo|escape}<br />&nbsp;</td>
			</tr>
			<tr bgcolor="#000032">
				<td width="30%" class="NormalC" valign="top" align="left">e-mail:</td>
				<td class="Normal"><a href="mailto:{$curr_people.email|escape}">{$curr_people.email|escape}</a><br />&nbsp;</td>
			</tr>
			<tr bgcolor="#000032">
				<td width="30%" class="NormalC" valign="top" align="left">recapito telefonico:</td>
				<td class="Normal">{$curr_people.recapito|escape}<br />&nbsp;</td>
			</tr>
			<tr bgcolor="#000032">
				<td width="30%" class="NormalC" valign="top" align="left">obiettivi:</td>
				
          <td class="Normal">&quot;{$curr_people.obiettivi|escape}&quot;</td>
			</tr>

			<tr bgcolor="#000099"> 
				<td colspan="2">
					<table summary="{$curr_people.nick|escape} 3" width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td align="left"><img src="tpl/black/rule_piccoloL.gif" width="200" height="2" alt="" /></td>
							<td align="right"><img src="tpl/black/rule_piccoloR.gif" width="200" height="2" alt="" /></td>
						</tr>
