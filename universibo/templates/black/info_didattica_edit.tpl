...
<textarea name="f18_obiettiviInfo" id="f18_obiettiviInfo">{$f18_obiettiviInfo|escape:"htmlall"}</textarea><br />
<label for="f18_obiettiviLink">{$infoDid_langObiettiviLink|escape:"htmlall"}&nbsp;</label><br />
<input type="text" name="f18_obiettiviLink" id="f18_obiettiviLink" value="{$f18_obiettiviLink|escape:"htmlall"}" /><br />

<label for="f18_programmaInfo">{$infoDid_langProgrammaInfo|escape:"htmlall"}&nbsp;</label><br />
<textarea name="f18_programmaInfo" id="f18_programmaInfo">{$f18_programmaInfo|escape:"htmlall"}</textarea><br />
<label for="f18_programmaLink">{$infoDid_langProgrammaLink|escape:"htmlall"}&nbsp;</label><br />
<input type="text" name="f18_programmaLink" id="f18_programmaLink" value="{$f18_programmaLink|escape:"htmlall"}" /><br />
		
<label for="f18_materialeInfo">{$infoDid_langMaterialeInfo|escape:"htmlall"}&nbsp;</label><br />
<textarea name="f18_materialeInfo" id="f18_materialeInfo">{$f18_materialeInfo|escape:"htmlall"}</textarea><br />
<label for="f18_materialeLink">{$infoDid_langMaterialeLink|escape:"htmlall"}&nbsp;</label><br />
<input type="text" name="f18_materialeLink" id="f18_materialeLink" value="{$f18_materialeLink|escape:"htmlall"}" /><br />
		
<label for="f18_modalitaInfo">{$infoDid_langModalitaInfo|escape:"htmlall"}&nbsp;</label><br />
<textarea name="f18_modalitaInfo" id="f18_modalitaInfo">{$f18_modalitaInfo|escape:"htmlall"}</textarea><br />
<label for="f18_modalitaLink">{$infoDid_langModalitaLink|escape:"htmlall"}&nbsp;</label><br />
<input type="text" name="f18_modalitaLink" id="f18_modalitaLink" value="{$f18_modalitaLink|escape:"htmlall"}" /><br />
		
<label for="f18_appelliInfo">{$infoDid_langAppelliInfo|escape:"htmlall"}&nbsp;</label><br />
<textarea name="f18_appelliInfo" id="f18_appelliInfo">{$f18_appelliInfo|escape:"htmlall"}</textarea><br />
