...
<tr>
<td><label for="f3_cdl">{$question_PersonalInfoData[4]|escape:"htmlall"}</label></td>
<td><input id="f3_cdl" maxlength="50" size="50" name="f3_cdl" value="{$f3_cdl|escape:"htmlall"}" /></td>
</tr>
</table>
</fieldset>
 <p>&nbsp;</p>
