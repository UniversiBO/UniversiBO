...
<tr><td>	
	...
	<tr><td class="Titolo" bgcolor="{cycle values="#000032,#000016"}">&nbsp;<img src="tpl/black/elle_begin.gif" width="10" height="12" alt="" />
	...
	<tr><td class="Normal" bgcolor="{cycle values="#000032,#000016"}">{$temp_helpid.contenuto|escape:"htmlall"|bbcode2html|nl2br}</td></tr>
	<td>&nbsp;</td></tr>
	{/foreach} 
	</table>
