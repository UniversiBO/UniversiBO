...
<p class="Normal" align="center">{$infoDid_langHomepageAlternativaLink|escape:"htmlall"}<br />
<a href="{$infoDid_homepageAlternativaLink|escape:"htmlall"}">{$infoDid_homepageAlternativaLink|escape:"htmlall"}</a></p>
{/if}
