...
class ShowContacts extends UniversiboCommand {
	function execute()
	{
		...
		$template->assign('contacts_langIntro', 'UniversiBO ? l\'associazione studentesca universitaria dell\'Ateneo di Bologna che dal settembre 2004 supporta la Web Community degli studenti.
