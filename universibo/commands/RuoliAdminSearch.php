...
class RuoliAdminSearch extends UniversiboCommand {
	...
	function execute() {
		...
		if (array_key_exists('f16_submit', $_POST)  )
		{
			...
			{
				Error :: throwError(_ERROR_NOTICE, array ('id_utente' => $user->getIdUtente(), 'msg' => 'Specificare almeno uno dei due criteri di ricerca', 'file' => __FILE__, 'line' => __LINE__, 'log' => false, 'template_engine' => & $template));
				$f16_accept = false;
			}	
