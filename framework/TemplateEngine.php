...
/**
 * Classe astratta che specifica l'interfaccia del template engine.
 ...
 * Allo stato attuale nel framework viene restituita una istanza di Smarty, che
 * anche se non eredita questa classe astratta nel rispetta l'interfaccia.
 *
 * @package framework
