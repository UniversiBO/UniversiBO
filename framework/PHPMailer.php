...
class PHPMailer
{
    ...
    */
     ...
     * is Italian.
     * @param string $lang_type Type of language (e.g. English: "en")
     * @param string $lang_path Path to the language file directory
     * @access public
     * @return bool
     */
    function SetLanguage($lang_type, $lang_path = "phpmailer-lang/") {
        if(file_exists($lang_path.'phpmailer.lang-'.$lang_type.'.php'))
            include($lang_path.'phpmailer.lang-'.$lang_type.'.php');
        else if(file_exists($lang_path.'phpmailer.lang-it.php'))
            include($lang_path.'phpmailer.lang-it.php');
        else
        {
            $this->SetError("Impossibile caricare il file della lingua");
            return false;
        }
    ...
    function Lang($key) {
        if(count($this->language) < 1)
            $this->SetLanguage("it"); // set the default language
