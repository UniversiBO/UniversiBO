...
<div class="comandi">
    <img src="{$common_basePath}/bundles/universibolegacy/images/file_new.gif" width="15" height="15" alt="" />
    ...
    <div class="elencoFile">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="">
            ...
            {foreach name=listafile from=$temp_categoria.file item=temp_file}
                ...
                <td><a href="{$temp_file.download_uri|escape:"htmlall"}"><img src="{$common_basePath}/bundles/universibolegacy/images/file_download.gif" border="0" width="15" height="15" alt="scarica il file" vspace="2" hspace="1"/></a></td></tr>
            {/foreach}
        </table>
</div>
{/foreach}
