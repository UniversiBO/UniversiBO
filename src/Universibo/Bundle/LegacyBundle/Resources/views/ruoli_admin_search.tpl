...
{foreach from=$ruoliAdminSearch_users key=temp_key item=temp_currGroup}
    ...
    {foreach from=$temp_currGroup item=temp_currLink}
        ...
        {if $temp_currLink.ruolo=="R"}&nbsp;<img src="{$common_basePath}/bundles/universibolegacy/images/icona_r.gif" width="9" height="9" alt="Referente" />&nbsp;Referente{/if}</td><td>
        {if $temp_currLink.ruolo=="M"}&nbsp;<img src="{$common_basePath}/bundles/universibolegacy/images/icona_m.gif" width="9" height="9" alt="Moderatore" />&nbsp;Moderatore{/if}</td><td>
