...
{foreach from=$contacts_langPersonal item=temp_curr_people}
    <tr class="{cycle values="even,odd"}">
      ...
      <td>
        {if $temp_curr_people.inserisci != 'false'}<img src="{$common_basePath}/bundles/universibolegacy/images/file_new.gif" width="10" height="9" /><a href="{$temp_curr_people.inserisci|escape:"htmlall"}">&nbsp;Inserisci&nbsp;profilo&nbsp;collaboratore</a>{/if}
      </td>
    </tr>
{/foreach}
</table>
