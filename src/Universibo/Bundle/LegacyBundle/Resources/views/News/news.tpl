...
<div class="news">
    <h3>::&nbsp;{$titolo|escape:"htmlall"|nl2br}&nbsp;::{if $nuova=="true"}&nbsp;&nbsp;<img src="{$common_basePath}/bundles/universibolegacy/images/icona_new.gif" width="21" height="9" alt="!NEW!" />{/if}{if $scadenza!=""}{$scadenza|escape:"htmlall"|bbcode2html|nl2br}{/if}</h3>
    ...
    <table><tr><td>
    <span class="actions">
        {if $modifica!="" && $elimina!=""}&nbsp;&nbsp;&nbsp;<img src="{$common_basePath}/bundles/universibolegacy/images/news_edt.gif" width="15" height="15" alt="modifica" />
        <a href="{$modifica_link|escape:"htmlall"}">{$modifica|escape:"htmlall"|nl2br}</a>
        &nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<img src="{$common_basePath}/bundles/universibolegacy/images/file_del.gif" width="15" height="15" alt="elimina" />
