...
INSERT INTO "help" ("id_help", "titolo", "contenuto", "ultima_modifica", "indice") VALUES ('21', 'Come faccio a modificare un file gia'' inserito nella pagina?', 'Per Modificare un file già presente sul sito bisogna cliccare su link ''Modifica'' che vi viene visualizzato al di sotto del file (ovviamente l''opzione comparira'' solo se l''utente ha i diritti necessari, ovvero solo se e'' un collaboratore o un professore).\r\nSi aprirà un popup analogo a quello utilizzato per [url=index.php?do=ShowHelp#20]caricare il file on line[/url] con le informazioni che sono già state inserite. Effettuate le modifiche necessarie, e'' sufficiente cliccare sul pulsante ''Modifica''.\r\nSe la modifica ha avuto successo, comparira'' una notifica.', '123719263', '180');
INSERT INTO "help" ("id_help", "titolo", "contenuto", "ultima_modifica", "indice") VALUES ('22', 'Come faccio ad eliminare un file?', 'Per eliminare un file (sempre che se ne abbia i diritti, ovvero se si e'' un collaboratore o un professore) bisogna cliccare sul link ''Elimina''.  Apparirà una finestra (popup) per confermare la cancellazione. Se si e'' sicuri di volerlo cancellare, cliccare su ''Elimina''.\r\nA questo punto nessuno potrà più accedere al file al di fuori degli amministratori. Infatti, per ragioni di [b]sicurezza[/b], verrà conservata una copia del file [color=red]non accessibile dal web[/color].', '182791', '190');
...
INSERT INTO "help" ("id_help", "titolo", "contenuto", "ultima_modifica", "indice") VALUES ('28', 'Come faccio a modificare una notizia?', 'Per modificare una notizia già presente sul sito bisogna cliccare su link ''Modifica'' che vi viene visualizzato al di sotto del file (ovviamente l''opzione comparira'' solo se l''utente ha i diritti necessari, ovvero solo se e'' un collaboratore o un professore).\r\nSi aprirà un popup analogo a quello utilizzato per [url=index.php?do=ShowHelp#27]inserire la notizia[/url] con le informazioni che sono già state scritte. Effettuate le modifiche necessarie, e'' sufficiente cliccare sul pulsante ''Modifica''.\r\nSe la modifica ha avuto successo, comparira'' una notifica.', '132123123', '230');
INSERT INTO "help" ("id_help", "titolo", "contenuto", "ultima_modifica", "indice") VALUES ('29', 'Come faccio ad eliminare una notizia?', 'Per eliminare una notizia (sempre che se ne abbia i diritti, ovvero se si e'' un collaboratore o un professore) bisogna cliccare sul link ''Elimina''. Apparirà una finestra (popup) per confermare la cancellazione. Se si e'' sicuri di volerla cancellare, cliccare su ''Elimina''.', '1231231', '240');
...
INSERT INTO "help" ("id_help", "titolo", "contenuto", "ultima_modifica", "indice") VALUES ('31', 'Che cos''e'' un forum?', 'Un forum e'' una bacheca virtuale in cui ogni utente puo'' inserire ([b]postare[/b]) un messaggio ([b]post[/b]).\r\nUn forum e'' organizzato in sezioni, a loro volta suddivise in discussioni ([b]threads[/b] o [b]topic[/b]).\r\nN.B.: per poter interagire attivamente nel forum [url=index.php?do=ShowHelp#10]bisogna essere loggati[/url].', '23412314', '260');
INSERT INTO "help" ("id_help", "titolo", "contenuto", "ultima_modifica", "indice") VALUES ('5', 'Perche'' devo avere la mail di Ateneo per iscrivermi ad UniversiBO?', 'Perche'' [url=index.php?do=ShowHelp#4]la mail di Ateneo[/url] viene assegnata univocamente dall''Universita'' ad ogni singolo studente iscritto, e'' dunque un metodo d''identificazione di ogni utente registrato al sito UniversiBO.', '1000', '30');
INSERT INTO "help" ("id_help", "titolo", "contenuto", "ultima_modifica", "indice") VALUES ('17', 'Come faccio a personalizzare il servizio di news?', 'Una volta [url=index.php?do=ShowHelp#14]aggiunto l''esame ai preferiti[/url], viene impostata automaticamente dal sistema la possibilità di ricevere tutte le [url=https://uni147.ing.unibo.it/~evaimitico/universibo2/htmls/index.php?do=ShowHelp#16]news[/url] che vengono inserite nella pagina dell''esame d''interesse.  Una volta [url=index.php?do=ShowHelp#10]loggati[/url], andando nella pagina [url=index.php?do=ShowSettings]''Impostazioni''[/url] (link in alto a sinistra) e  cliccando su ''Impostazioni Personali'', troverete un campo in cui è segnato il vostro indirizzo e-mail a cui verranno spedite le news, e la possibilità di scegliere quali notizie ricevere e quali no.[list][*]Nessun messaggio: non vi verrà inviato nessun messaggio, nemmeno quelli urgenti.[*]Solo messaggi urgenti: solo le news indicate dal docente come urgenti vi verranno segnalate con una e-mail; [*]Tutti i messaggi: tutte le news inserite nei vostri esami preferiti vi verranno anche segnalate via e-mail.[/list]\r\nL''opzione di default è la terza.  Una volta selezionata la preferenza, cliccando su ''Invia'' vi verrà notificato se la modifica ha avuto successo e a questo punto si potrà chiudere la finestra.\r\n&#200; comunque sempre possibile modificare la scelta di notifica effettuata, ripetendo le operazioni sopra indicate.', '1231232', '140');
